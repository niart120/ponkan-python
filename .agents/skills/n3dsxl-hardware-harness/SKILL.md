...
- product string が `N3DSXL` または `N3DSXL.2` であること。
...
- metadata には product string、VID/PID、mode_3d、transferred、video_size、capture_size を含める。
...
- product string を確認できない device に command を送らない。
