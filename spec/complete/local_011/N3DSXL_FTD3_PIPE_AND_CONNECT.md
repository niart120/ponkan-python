...
| green | 実機 create/abort が libusb error なしで返る | hardware | 3.1 | D3XX fallback E2E で完了 |
| green | 実機 2D connect が完了する | hardware | 3.1 | D3XX fallback E2E で完了 |
