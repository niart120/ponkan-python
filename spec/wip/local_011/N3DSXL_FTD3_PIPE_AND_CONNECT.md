...
- [ ] `spec/wip/local_010/N3DSXL_DEVICE_DISCOVERY_AND_SESSION.md` の safe open / claim が実装済み。
...
| 前提 Work Unit | `spec/wip/local_010/N3DSXL_DEVICE_DISCOVERY_AND_SESSION.md` |
