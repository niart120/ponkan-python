...
```bash
pytest tests/unit/test_n3dsxl_constants.py
```
...
```bash
python -m py3dscapture.tools.list_devices
```
...
```bash
pytest -m requires_n3dsxl tests/e2e/test_n3dsxl_open_close.py
```
...
```bash
pytest tests/unit/test_ftd3_pipe_payloads.py
pytest -m requires_n3dsxl tests/e2e/test_n3dsxl_ftd3_pipe.py
```
...
```bash
pytest -m requires_n3dsxl tests/e2e/test_n3dsxl_connect.py
```
...
```bash
python -m py3dscapture.tools.capture_raw --model new_3ds_xl --out tests/fixtures/n3dsxl/raw_2d_001.bin
```
...
```bash
python -m py3dscapture.tools.raw_to_png tests/fixtures/n3dsxl/raw_2d_001.bin --metadata tests/fixtures/n3dsxl/raw_2d_001.json --out tests/fixtures/n3dsxl/
```
...
```bash
pytest -m requires_n3dsxl tests/e2e/test_n3dsxl_streaming.py
python -m py3dscapture.tools.stream_n3dsxl --duration 10 --stats
```
...
```bash
pytest -m "requires_n3dsxl and performance" tests/performance/test_n3dsxl_streaming_smoke.py
python -m py3dscapture.tools.stream_n3dsxl --duration 60 --noop-consumer --stats
```
